...
public class CombatDummyController : MonoBehaviour
{
    ...
    private GameObject aliveGO, brokenHeadGO, brokenTopGO, brokenBotGO;
    private Rigidbody2D rbAlive, rbBrokenHead, rbBrokenTop, rbBrokenBot;
    ...
    private void Start()
    {
        ...
        brokenHeadGO = transform.Find("Head Dummy").gameObject;
        brokenTopGO = transform.Find("Broken Top").gameObject;
        brokenBotGO = transform.Find("Broken Bottom").gameObject;

        aliveAnim = aliveGO.GetComponent<Animator>();
        rbAlive = aliveGO.GetComponent<Rigidbody2D>();
        rbBrokenHead = brokenHeadGO.GetComponent<Rigidbody2D>();
        rbBrokenTop = brokenTopGO.GetComponent<Rigidbody2D>();
        rbBrokenBot = brokenBotGO.GetComponent<Rigidbody2D>();

        aliveGO.SetActive(true);
        brokenHeadGO.SetActive(false);
    ...
    private void Die()
    {
        ...
        brokenHeadGO.SetActive(true);
        brokenTopGO.SetActive(true);
        brokenBotGO.SetActive(true);

        brokenHeadGO.transform.position = aliveGO.transform.position;
